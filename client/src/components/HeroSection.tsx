      ...
      <div className="container relative z-10 flex flex-col md:flex-row gap-8 md:gap-12">
        <div className="max-w-2xl md:flex-1">
          <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-900 mb-4 md:mb-6 leading-tight animate-fade-in-up drop-shadow-lg md:drop-shadow-none">
            Automatiza tu presencia en <span className="text-[#1B4F72] md:text-[#1B4F72]">WhatsApp Business API</span>
          </h1>

          <p className="text-base sm:text-lg text-gray-600 mb-6 md:mb-8 leading-relaxed max-w-xl animate-fade-in-up drop-shadow-md md:drop-shadow-none" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            <a

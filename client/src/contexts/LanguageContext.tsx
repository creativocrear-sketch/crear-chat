...
const translations = {
  es: {
    ...
    home: {
      ...
      subtitle:
        "Potencia tu comunicación con clientes usando WhatsApp Business API",
      cta: "Comenzar ahora",
      features: {
      ...
      platforms: {
        ...
        salesDesc:
          "Centraliza y gestiona tus oportunidades de venta desde WhatsApp en un solo lugar. Haz seguimiento a cada cliente, controla el proceso comercial y mejora el cierre de ventas con mayor orden y visibilidad.",
        orders: "Gestión de pedidos",
        ordersDesc:
          "Recibe y organiza todos tus pedidos directamente por WhatsApp en un solo lugar. Será un seguimiento para inventario, producción, entrega y facturación.",
        shifts: "Gestión de turnos de trabajo",
        shiftsDesc:
          "Organiza los turnos de tu equipo de manera automática y eficiente evitando confusiones. Olvídate de agendas dispersas y mantén a todos informados al instante a través de WhatsApp.",
        appointments: "Gestión de citas médicas",
        appointmentsDesc:
          "Permite que tus pacientes agenden, modifiquen o cancelen citas en segundos, mientras reciben recordatorios automáticos que reducen ausencias. Todo el control está en WhatsApp, de manera sencilla y confiable.",
        balances: "Consultas de saldos y deudas",
        balancesDesc:
          "Permite que tus clientes consulten sus saldos y deudas al instante, directamente desde WhatsApp. Mantén la información siempre accesible y actualizada, mejorando la comunicación y la transparencia.",
        loyalty: "Fidelización de clientes",
        loyaltyDesc:
          "Permite que tus clientes acumulen puntos dependiendo de las compras que hayan hecho. Gestiona premios, descuentos y bonificaciones para impulsar la recompra y nuevas ventas.",
      },
      integrations: {
        ...
        emailDesc:
          "Integra el envío de correos electrónicos automatizados para comunicaciones programadas y seguimiento de clientes.",
      },
    },
    // Footer
    footer: {
      description:
        "Agencia especializada en automatización de WhatsApp Business API",
    ...
    plans: {
      ...
      customPlanDesc:
        "¿Necesitas una solución a medida? Contáctanos y crearemos un plan personalizado para ti.",
      ...
      plans: {
        ...
        plan5: {
          ...
          period: "Año",
          description:
            "Flujos de trabajo multiequipo, informes avanzados e integraciones flexibles para medianas empresas.",
          features: [
    ...
    articles: {
      article1: {
        ...
        subtitle:
          "Descubre las diferencias clave y elige la mejor opción para tu negocio",
        intro:
          "En el mundo empresarial actual, la comunicación efectiva con los clientes es fundamental. WhatsApp se ha convertido en una herramienta esencial, pero existe confusión sobre cuál versión usar: WhatsApp Business estándar o WhatsApp Business API.",
        conclusion:
          "La elección entre WhatsApp Business y WhatsApp Business API depende del tamaño de tu negocio, volumen de mensajes y necesidades de automatización.",
        shareText:
      ...
      article2: {
        ...
        intro:
          "WhatsApp Business API abre un mundo de posibilidades para businesses que buscan escalar su comunicación.",
        conclusion:
          "WhatsApp Business API es versátil y se adapta a múltiples industrias y casos de uso.",
        shareText:
      ...
      article3: {
        ...
        intro:
          "Migrar a WhatsApp Business API puede parecer complejo, pero con la guía adecuada es un proceso manejable.",
        conclusion:
          "La migración requiere planificación pero los beneficios a largo plazo valen el esfuerzo.",
        shareText:
      ...
      article4: {
        ...
        intro:
          "La inteligencia artificial transformada la manera en que las empresas interactúan con sus clientes.",
        conclusion:
          "La combinación de WhatsApp Business API e IA es el futuro de la comunicación empresarial.",
        shareText:
      ...
      article5: {
        ...
        intro:
          "Elegir la plataforma adecuada es crucial para maximizar los beneficios de WhatsApp Business API.",
        conclusion:
          "La plataforma ideal depende de tus necesidades específicas y presupuesto.",
        shareText:
          "Descubre las mejores plataformas para integrar WhatsApp Business API con tus sistemas existentes.",
      },
      article6: {
        title:
          "¿Por qué necesito una plataforma para administrar chats de WhatsApp?",
        subtitle: "La importancia de la gestión profesional",
        intro:
          "A medida que tu negocio crece, gestionar WhatsApp manualmente se vuelve insostenible.",
        conclusion:
          "Invertir en una plataforma de gestión es esencial para escalar eficientemente.",
        shareText:
          "Descubre por qué necesitas una plataforma profesional para gestionar WhatsApp Business API eficientemente.",
      },
      article7: {
        title:
        ...
        intro:
          "El mercado ofrece múltiples opciones para gestionar WhatsApp Business API.",
        conclusion:
          "Cada plataforma tiene fortalezas únicas para diferentes tipos de negocios.",
        shareText:
          "Análisis comparativo completo de plataformas para administrar WhatsApp Business API.",
      },
      article8: {
        title:
        ...
        intro:
          "Los costos de WhatsApp Business API pueden ser confusos al principio.",
        conclusion:
          "Entender la estructura de costos te ayudará a tomar decisiones informadas.",
        shareText:
          "Guía completa sobre cómo funcionan los modelos de precios en las plataformas de WhatsApp Business API.",
      },
      article9: {
        title:
        ...
        intro:
          "Seleccionar el proveedor adecuado es una decisión crítica para tu negocio.",
        conclusion:
          "Tómate el tiempo necesario para evaluar todas las opciones disponibles.",
        shareText:
          "Guía completa para seleccionar el mejor proveedor de WhatsApp y plataforma para tu negocio.",
      },
      article10: {
        title:
        ...
        intro:
          "WhatsApp tiene políticas estrictas que debes cumplir para usar su API.",
        conclusion:
          "El cumplimiento de políticas es fundamental para el éxito a largo plazo.",
        shareText:
          "Conoce las políticas y normativas clave de WhatsApp Business API para evitar restricciones.",
      },
      article11: {
        title: "¿Por qué pueden restringir el número de WhatsApp?",
        subtitle: "Causas comunes y cómo evitarlas",
        intro:
          "Las restricciones de número pueden afectar gravemente tu operación.",
        conclusion:
          "La prevención es la mejor estrategia contra las restricciones.",
        shareText:
          "Conoce las razones por las que WhatsApp puede restringir tu número y cómo evitarlo.",
      },
    },
    // Common
    common: {
  ...
  en: {
    ...
    home: {
      ...
      subtitle:
        "Power up your customer communication using WhatsApp Business API",
      cta: "Get started now",
      features: {
        title: "Main features",
      ...
      services: {
        ...
        consultingDesc:
          "We advise companies on implementing and optimizing WhatsApp Business API to automate communication, improve customer service, and boost commercial management.",
        marketing: "Automation and Digital Marketing Strategies",
        marketingDesc:
          "We design data-driven automation and digital marketing strategies to attract customers, optimize processes, and increase conversion through intelligent communication and automated campaigns.",
        customerService: "Customer Service Channel Automation",
        customerServiceDesc:
          "We automate customer service channels through technological solutions that optimize communication, improve user experience, and increase operational efficiency.",
        sales: "Sales Automation and Conversion Optimization",
        salesDesc:
          "We automate sales processes and optimize customer conversion through technology, data, and digital strategies that improve commercial efficiency and increase results.",
        platform: "Integrated Chat Management Platform",
        platformDesc:
          "We centralize WhatsApp and Instagram conversation management in one platform to optimize service, automate responses, and improve customer communication.",
        database: "Intelligent Contact Database Management",
        databaseDesc:
          "We manage and optimize contact databases to ensure updated information, precise segmentation, and better performance in commercial and digital marketing strategies.",
      },
      platforms: {
        sales: "Sales Management",
        salesDesc:
          "Centralize and manage your sales opportunities from WhatsApp in one place. Follow up with each customer, control the commercial process and improve sales closure with better order and visibility.",
        orders: "Order Management",
        ordersDesc:
          "Receive and organize all your orders directly through WhatsApp in one place. Track inventory, production, delivery and invoicing.",
        shifts: "Work Shift Management",
        shiftsDesc:
          "Organize your team shifts automatically and efficiently avoiding confusion. Forget scattered schedules and keep everyone informed instantly through WhatsApp.",
        appointments: "Medical Appointment Management",
        appointmentsDesc:
          "Allow your patients to schedule, modify or cancel appointments in seconds, while receiving automatic reminders that reduce no-shows. All control is in WhatsApp, simple and reliable.",
        balances: "Balance and Debt Inquiries",
        balancesDesc:
          "Allow your customers to check their balances and debts instantly, directly from WhatsApp. Keep information always accessible and updated, improving communication and transparency.",
        loyalty: "Customer Loyalty",
        loyaltyDesc:
          "Allow your customers to accumulate points depending on their purchases. Manage rewards, discounts and bonuses to drive repurchases and new sales.",
      },
      integrations: {
        whatsapp: "WhatsApp Business API",
        whatsappDesc:
          "We integrate your business with WhatsApp Business API to automate messages, manage conversations and scale customer service from a single system.",
        instagram: "Instagram",
        instagramDesc:
          "Centralize Instagram direct messages and manage conversations from a unified platform.",
        sheets: "Google Sheets",
        sheetsDesc:
          "Automatically sync contact, conversation or order information with Google Sheets for analysis and data management.",
        crm: "CRM (HubSpot and others)",
        crmDesc:
          "We integrate your system with CRM like HubSpot to organize contacts, register interactions and improve commercial follow-up.",
        zapier: "Automations (Zapier)",
        zapierDesc:
          "Connect crear.chat with hundreds of applications to automate processes and workflows between different platforms.",
        sms: "SMS",
        smsDesc:
          "Send automated SMS messages for notifications, reminders or important communications with your customers.",
        email: "Email",
        emailDesc:
          "Integrate automated email sending for scheduled communications and customer follow-up.",
      },
    },
    // Footer
    footer: {
    ...
    plans: {
      ...
      customPlanDesc:
        "Need a custom solution? Contact us and we will create a personalized plan for you.",
      ...
      plans: {
        plan1: {
          ...
          period: "Year",
          description:
            "Professional tools for small businesses to market, sell and support across multiple channels",
          features: [
        ...
        plan5: {
          ...
          period: "Year",
          description:
            "Multi-team workflows, advanced reports and flexible integrations for medium businesses.",
          features: [
      ...
      alcaldias: {
        ...
        description:
          "Implemente WhatsApp Business API para mejorar la atención ciudadana, fortalecer el turismo y responder con más eficiencia.",
        hero: {
          title: "Innovación para Gobiernos Locales",
          subtitle:
            "Convierte WhatsApp en tu mejor herramienta de gestión ciudadana",
        },
        cta: {
        ...
        article1: {
          ...
          subtitle:
            "Automatiza la atención, mejora la experiencia y aumenta el consumo turístico en tu ciudad o negocio",
          intro: "El problema que tienes (incluso si no te das cuenta)",
          problem: {
            title: "El turista de hoy es inmediato. No espera.",
            description:
              'Si alguien pregunta: "¿Qué hacer hoy?", "¿Dónde está este lugar?", "¿Qué hay cerca?" y no recibe respuesta en segundos... simplemente va a otra opción.',
            issues: [
            ...
            conclusion:
              "Cada mensaje sin respuesta es dinero que estás dejando en la mesa.",
          },
          solution: {
            title: "La solución: Turismo IA en WhatsApp",
            description:
              "Ahora puedes tener un asistente inteligente que responde automáticamente a cada turista, a cualquier hora del día. Sin apps. Sin descargas. Sin fricción. Directamente desde WhatsApp.",
            features: [
            ...
            adaptation:
              "Incluso puede adaptarse a lo que busca el usuario: Turismo económico, Planes familiares, Experiencias premium",
          },
          benefits: {
            title: "Beneficios para tu ciudad",
            intro:
              "Más que solo responder preguntas, estás transformando la experiencia turística completa.",
            keyBenefits: [
          ...
          whyWhatsApp: {
            ...
            conclusion:
              "Donde ya están tus clientes, ahí debe estar tu servicio.",
          },
          conclusion:
            "Comienza hoy mismo a transformar la atención turística de tu ciudad. No dejes que otro mensaje sin respuesta se convierta en otra oportunidad perdida.",
          shareText:
            "Descubre cómo convertir WhatsApp en el mejor guía turístico 24/7 para tu ciudad o negocio.",
        },
      },
    },
    // Blog Articles
    articles: {
      article1: {
        ...
        subtitle:
          "Discover key differences and choose the best option for your business",
        intro:
          "In today's business world, effective customer communication is essential. WhatsApp has become an essential tool, but there's confusion about which version to use: standard WhatsApp Business or WhatsApp Business API.",
        conclusion:
          "The choice between WhatsApp Business and WhatsApp Business API depends on your business size, message volume, and automation needs.",
        shareText:
        ...
        content: {
          intro:
            "In today's business world, WhatsApp has become a fundamental tool for customer communication. However, many businesses are confused between WhatsApp Business and WhatsApp Business API. Although both are WhatsApp solutions, they have significant differences that are important to understand.",
          basicTitle: "WhatsApp Business: The Basic Solution",
          basicDesc:
            "WhatsApp Business is a free mobile application designed for small businesses. It's the simplified version of WhatsApp that allows business owners to create a business profile with information such as business hours, location, and business description.",
          ...
          basicConclusion:
            "This solution is ideal for small businesses that need a basic presence on WhatsApp without complex automation requirements.",
          apiTitle: "WhatsApp Business API: The Enterprise Solution",
          apiDesc:
            "WhatsApp Business API is a robust and scalable solution designed for medium and large businesses. Unlike WhatsApp Business, the API allows integration with business systems, process automation, and massive conversation management.",
      ...
      article2: {
        ...
        intro:
          "WhatsApp Business API opens a world of possibilities for businesses looking to scale their communication.",
        conclusion:
          "WhatsApp Business API is versatile and adapts to multiple industries and use cases.",
        shareText:
          "Explore real use cases of WhatsApp Business API in restaurants, hotels, cafes, lawyers, and collection offices.",
        content: {
          intro:
            "WhatsApp Business API is a transformative tool that can revolutionize how your business communicates with customers. Let's see how different industries can benefit from this powerful platform.",
          restaurantTitle: "Restaurants: Optimize Your Customer Service",
          restaurantUseCase:
            "Use Case: Automatic reservations and confirmations",
          ...
          restaurantWithAIText:
            "An AI chatbot can answer questions about the menu, table availability, hours, and dietary restrictions without human intervention, improving customer experience and reducing workload.",
        },
      },
      article3: {
        ...
        intro:
          "Migrating to WhatsApp Business API may seem complex, but with proper guidance it's a manageable process.",
        conclusion:
          "Migration requires planning but the long-term benefits are worth the effort.",
        shareText:
      ...
      article4: {
        ...
        intro:
          "Artificial intelligence is transforming how businesses interact with their customers.",
        conclusion:
          "The combination of WhatsApp Business API and AI is the future of business communication.",
        shareText:
      ...
      article5: {
        ...
        intro:
          "Choosing the right platform is crucial to maximize the benefits of WhatsApp Business API.",
        conclusion:
          "The ideal platform depends on your specific needs and budget.",
        shareText:
          "Discover the best platforms to integrate WhatsApp Business API with your existing systems.",
      },
      article6: {
        title: "Why do I need a platform to manage WhatsApp chats?",
        subtitle: "The importance of professional management",
        intro:
          "As your business grows, managing WhatsApp manually becomes unsustainable.",
        conclusion:
          "Investing in a management platform is essential to scale efficiently.",
        shareText:
          "Discover why you need a professional platform to efficiently manage WhatsApp Business API.",
      },
      article7: {
        title:
        ...
        intro:
          "The market offers multiple options for managing WhatsApp Business API.",
        conclusion:
          "Each platform has unique strengths for different types of businesses.",
        shareText:
          "Complete comparative analysis of platforms for managing WhatsApp Business API.",
      },
      article8: {
        ...
        conclusion:
          "Understanding the cost structure will help you make informed decisions.",
        shareText:
          "Complete guide on how pricing models work in WhatsApp Business API platforms.",
      },
      article9: {
        title:
        ...
        intro:
          "Selecting the right provider is a critical decision for your business.",
        conclusion:
          "Take the necessary time to evaluate all available options.",
        shareText:
          "Complete guide to select the best WhatsApp provider and platform for your business.",
      },
      article10: {
        title: "What are the main policies of WhatsApp Business API?",
        subtitle: "Rules you must know",
        intro:
          "WhatsApp has strict policies that you must comply with to use their API.",
        conclusion: "Policy compliance is fundamental for long-term success.",
        shareText:
          "Learn the key policies and regulations of WhatsApp Business API to avoid restrictions.",
      },
      article11: {
        ...
        shareText:
          "Learn the reasons why WhatsApp can restrict your number and how to avoid it.",
      },
    },
    // Common
    common: {

          ...
          <div className="container">
            <div className="max-w-4xl mx-auto">
              <article className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Tus usuarios sí quieren información... pero no quieren llamar."
                    : "Your users do want information... but they don't want to call."}
                </p>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Hoy seguramente tienes:"
                    : "Today you surely have:"}
                </p>
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ? "La solución: IA de consulta de deudas en WhatsApp"
                    : "The solution: AI debt inquiry on WhatsApp"}
                </h3>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Permite que cualquier usuario consulte su estado de cuenta en segundos, sin necesidad de hablar con un asesor."
                    : "Allow any user to check their account status in seconds, without needing to speak with an advisor."}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ...
                    : "No calls. No waits. No complications."}
                </p>
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ? "¿Qué tipo de consultas puede responder?"
                    : "What type of queries can it answer?"}
                </h3>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  {language === "es"
                    ? [
                      ...
                      ].map((query, index) => <li key={index}>{query}</li>)
                    : [
                        "Current debt status",
                        "Basic history",
                        "Payment dates",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      {language === "es"
                        ? "Tu equipo deja de responder consultas repetitivas."
                        : "Your team stops answering repetitive queries."}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-900 mb-2">
                    ...
                    <p className="text-sm text-gray-600">
                      {language === "es"
                        ? "El usuario obtiene respuestas en segundos."
                        : "The user gets answers in seconds."}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-900 mb-2">
                    ...
                    <p className="text-sm text-gray-600">
                      {language === "es"
                        ? "Proceso rápido, claro y sin fricción."
                        : "Fast, clear, and frictionless process."}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-900 mb-2">
                    ...
                    <p className="text-sm text-gray-600">
                      {language === "es"
                        ? "Reduces llamadas y tickets de soporte."
                        : "You reduce calls and support tickets."}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-900 mb-2">
                    ...
                    <p className="text-sm text-gray-600">
                      {language === "es"
                        ...
                        : "You centralize information in one channel."}
                    </p>
                  </div>
                </div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ? "\ud83d\udc49 Estás llevando la información donde el usuario ya está."
                    : "\ud83d\udc49 You're taking information where the user already is."}
                </p>
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ? "Moderniza tu atención hoy"
                    : "Modernize your service today"}
                </h3>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Deja de saturar tus canales con consultas repetitivas."
                    : "Stop saturating your channels with repetitive queries."}
                </p>

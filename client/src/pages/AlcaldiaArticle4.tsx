            ...
            <div className="max-w-4xl mx-auto">
              <article className="prose prose-lg max-w-none">
                <h2 className="text-2xl font-bold text-gray-900 mb-4">
                  {language === "es"
                    ? "El problema en la atención al ciudadano"
                    : "The problem in citizen service"}
                </h2>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Miles de personas necesitan información sobre subsidios... pero el acceso sigue siendo complicado."
                    : "Thousands of people need information about subsidies... but access remains complicated."}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ? "\ud83d\udc49 Resultado: ciudadanos frustrados y desinformados."
                    : "\ud83d\udc49 Result: frustrated and uninformed citizens."}
                </p>

                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ? "La solución: IA de consulta de subsidios por WhatsApp"
                    : "The solution: subsidy inquiry AI via WhatsApp"}
                </h3>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Permite que cualquier persona consulte su información en segundos, desde su celular."
                    : "Allows anyone to consult their information in seconds, from their cell phone."}
                </p>
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ? "Beneficios que transforman la atención"
                    : "Benefits that transform service"}
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">
                      {language === "es"
                        ? "Consultas sin filas ni desplazamientos."
                        : "Consultations without lines or travel."}
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-900 mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-900 mb-2">
                      {"\ud83c\udff0"}{" "}
                      {language === "es" ? "Gobernaciones" : "Governorates"}
                    </h5>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h5 className="font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Lleva los servicios públicos al canal más usado por la ciudadanía."
                    : "Take public services to the most used channel by citizens."}
                </p>

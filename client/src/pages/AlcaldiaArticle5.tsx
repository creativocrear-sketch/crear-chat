          ...
          <div className="container">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl text-gray-900 mb-6 leading-tight">
                {language === "es"
                  ? "🚓 CONSULTA DE TURNOS DE AGENTES DE TRÁNSITO POR WHATSAPP"
                  : "🚓 TRAFFIC AGENT SHIFT INQUIRY VIA WHATSAPP"}
              </h1>
            ...
            <div className="max-w-4xl mx-auto">
              <article className="prose prose-lg max-w-none">
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Acceso inmediato a la programación, menos carga operativa y mejor coordinación en campo"
                    : "Immediate access to scheduling, less operational load and better field coordination"}
                </p>

                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ? "⚠️ El problema en la operación diaria"
                    : "⚠️ The problem in daily operations"}
                </h3>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "La información sobre turnos muchas veces no está disponible de forma rápida ni clara."
                    : "Information about shifts is often not available quickly or clearly."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  {language === "es"
                    ? [
                        <li key="1">
                          Agentes que no tienen certeza de su horario
                        </li>,
                        <li key="2">
                          Llamadas y mensajes constantes al área administrativa
                        </li>,
                        <li key="3">Errores en la asistencia o cobertura</li>,
                        <li key="4">
                          Dificultad para consultar cambios de último momento
                        </li>,
                      ]
                    : [
                        <li key="1">Agents unsure of their schedule</li>,
                        <li key="2">
                          Constant calls and messages to the administrative area
                        </li>,
                        <li key="3">Errors in attendance or coverage</li>,
                        <li key="4">
                          Difficulty consulting last-minute changes
                        </li>,
                      ]}
                </ul>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ? "👉 Resultado: desorganización, pérdida de tiempo y fallas en la operación."
                    : "👉 Result: disorganization, wasted time and operational failures."}
                </p>

                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ? "🤖 La solución: IA para consulta de turnos en WhatsApp"
                    : "🤖 The solution: AI for shift inquiry via WhatsApp"}
                </h3>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Permite que cada agente consulte su turno en segundos, directamente desde WhatsApp, sin depender de terceros."
                    : "Allows each agent to consult their shift in seconds, directly from WhatsApp, without depending on third parties."}
                </p>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Solo debe escribir algo como:"
                    : "They just need to write something like:"}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Y la IA responde automáticamente con su información actualizada."
                    : "And the AI responds automatically with their updated information."}
                </p>

                <h4 className="text-lg font-semibold text-gray-900 mb-3 mt-6">
                  {language === "es"
                    ? "📲 ¿Qué puede consultar el agente?"
                    : "📲 What can the agent consult?"}
                </h4>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "En una sola interacción puede obtener:"
                    : "In a single interaction they can obtain:"}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  {language === "es"
                    ? [
                        ...
                        <li key="3">
                          Tipo de servicio (control, evento, apoyo, etc.)
                        </li>,
                    ...
                    : [
                        ...
                        <li key="3">
                          Service type (control, event, support, etc.)
                        </li>,
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ? "👉 Toda la información clara, organizada y en tiempo real."
                    : "👉 All information clear, organized and in real time."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  {language === "es"
                    ? [
                        ...
                        <li key="2">
                          Se identifica (cédula, código o número autorizado)
                        </li>,
                        <li key="3">La IA consulta la base de datos</li>,
                        <li key="4">
                          Responde en segundos con el turno correspondiente
                        </li>,
                      ]
                    : [
                        <li key="1">The agent writes via WhatsApp</li>,
                        <li key="2">
                          They identify themselves (ID, code or authorized
                          number)
                        </li>,
                        <li key="3">The AI queries the database</li>,
                        <li key="4">
                          Responds in seconds with the corresponding shift
                        </li>,
                      ]}
                </ul>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ? "Sin llamadas. Sin intermediarios. Sin demoras."
                    : "No calls. No intermediaries. No delays."}
                </p>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  {language === "es"
                    ? "Elimina consultas manuales al área administrativa."
                    : "Eliminates manual inquiries to the administrative area."}
                </p>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  {language === "es"
                    ? "Información disponible 24/7 desde el celular."
                    : "Information available 24/7 from the cell phone."}
                </p>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  {language === "es"
                    ? "Cada agente tiene claridad sobre su turno."
                    : "Each agent has clarity about their shift."}
                </p>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  {language === "es"
                    ? "Reduce confusión y dependencias."
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Centralizas la información en un solo canal."
                    : "You centralize information in a single channel."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  {language === "es"
                    ? [
                        ...
                        <li key="3">
                          Confirmación de cambios de último momento
                        </li>,
                    ...
                    : [
                        ...
                        <li key="2">
                          Verification before starting the workday
                        </li>,
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Cualquier cambio en el sistema se refleja inmediatamente en la consulta del agente."
                    : "Any change in the system is immediately reflected in the agent's inquiry."}
                </p>

                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ? "👉 Esto permite reaccionar rápidamente ante ajustes operativos."
                    : "👉 This allows quick reaction to operational adjustments."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  {language === "es"
                    ? [
                        ...
                        <li key="4">
                          Permite consultas rápidas en cualquier momento
                        </li>,
                      ]
                    : [
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-semibold">
                  {language === "es"
                    ? "👉 La información llega donde realmente se necesita: en campo."
                    : "👉 Information reaches where it's really needed: in the field."}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "No es solo un canal de consulta."
                    : "It's not just an inquiry channel."}
                </p>
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3 mt-6">
                  {language === "es"
                    ? "📲 Moderniza la consulta de turnos"
                    : "📲 Modernize shift inquiry"}
                </h4>

                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ? "Facilita el acceso a la información y mejora la eficiencia de tu equipo."
                    : "Facilitates access to information and improves your team's efficiency."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  {language === "es"
                    ? [
                        ...
                        <li key="2">
                          👉 Implementa consulta inteligente de turnos
                        </li>,
                    ...
                    : [
                        ...
                        <li key="3">
                          👉 Optimize your operation starting today 🚀
                        </li>,
                      ]}
                </ul>
              </article>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12 text-center">
                  ...
                  <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
                    {language === "es"
                      ? "Implementa WhatsApp Business API y comienza a automatizar la gestión de turnos"
                      : "Implement WhatsApp Business API and start automating shift management"}
                  </p>
                  <a

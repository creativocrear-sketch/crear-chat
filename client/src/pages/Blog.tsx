...
const getBlogArticles = (language: string) => [
  ...
  },
  {
    ...
    title:
      language === "es"
        ? "¿Con qué plataformas puedo integrar el WhatsApp Business API?"
        : "What platforms can I integrate WhatsApp Business API with?",
    excerpt:
      language === "es"
        ? "Descubre todas las plataformas y sistemas que puedes integrar con WhatsApp Business API."
        : "Discover all platforms and systems you can integrate with WhatsApp Business API.",
    date: language === "es" ? "21 de Marzo de 2026" : "March 21, 2026",
    readTime: language === "es" ? "6 min" : "6 min",
  },
  {
    ...
    excerpt:
      language === "es"
        ? "Entiende por qué una plataforma de gestión es esencial para WhatsApp Business API."
        : "Understand why a management platform is essential for WhatsApp Business API.",
    date: language === "es" ? "21 de Marzo de 2026" : "March 21, 2026",
    readTime: language === "es" ? "5 min" : "5 min",
  },
  {
    ...
    title:
      language === "es"
        ? "¿En qué se diferencian las plataformas que administran los chat de WhatsApp?"
        : "How do platforms that manage WhatsApp chats differ?",
    excerpt:
      language === "es"
        ? "Comparativa detallada de las principales plataformas de gestión de WhatsApp."
        : "Detailed comparison of the main WhatsApp management platforms.",
    date: language === "es" ? "21 de Marzo de 2026" : "March 21, 2026",
    readTime: language === "es" ? "7 min" : "7 min",
  },
  {
    ...
    excerpt:
      language === "es"
        ? "Entiende los diferentes modelos de precios de las plataformas de gestión de WhatsApp."
        : "Understand the different pricing models of WhatsApp management platforms.",
    date: language === "es" ? "21 de Marzo de 2026" : "March 21, 2026",
    readTime: language === "es" ? "6 min" : "6 min",
  },
  {
    ...
    excerpt:
      language === "es"
        ? "Guía completa para elegir el mejor proveedor y plataforma de WhatsApp para tu negocio."
        : "Complete guide to choose the best WhatsApp provider and platform for your business.",
    date: language === "es" ? "21 de Marzo de 2026" : "March 21, 2026",
    readTime: language === "es" ? "7 min" : "7 min",
  },
  {
    ...
    excerpt:
      language === "es"
        ? "Entiende las reglas y políticas que debes cumplir para usar WhatsApp Business API."
        : "Understand the rules and policies you must comply with to use WhatsApp Business API.",
    date: language === "es" ? "21 de Marzo de 2026" : "March 21, 2026",
    readTime: language === "es" ? "6 min" : "6 min",
  },
  {
    ...
    title:
      language === "es"
        ...
        : "Why might my WhatsApp number be restricted?",
    excerpt:
      language === "es"
        ? "Entiende las razones por las que WhatsApp restringe o suspende números."
        : "Understand the reasons why WhatsApp restricts or suspends numbers.",
    date: language === "es" ? "21 de Marzo de 2026" : "March 21, 2026",
    readTime: language === "es" ? "5 min" : "5 min",
  },
];
              ...
              <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-[#1B4F72]">
                    {language === "es" ? "11 artículos" : "11 articles"}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-semibold text-[#1B4F72]">
              ...
              <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-blue-100">
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  {language === "es"
                    ...
                    : "Implement WhatsApp Business API and start automating your customer communication"}
                </p>

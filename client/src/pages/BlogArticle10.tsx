              ...
              <article className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "WhatsApp has strict policies to maintain the integrity of its platform. It is crucial to understand them to avoid problems."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "WhatsApp monitorea si tus mensajes son bloqueados/reportados"
                      : "WhatsApp monitors if your messages are blocked/reported"}
                  </li>
                  <li>
                    {language === "es"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es" ? "No envíes spam" : "Do not send spam"}
                  </li>
                  <li>
                    {language === "es"
                      ? "No envíes contenido ilegal"
                      : "Do not send illegal content"}
                  </li>
                  <li>
                    {language === "es"
                      ? "No envíes phishing o estafas"
                      : "Do not send phishing or scams"}
                  </li>
                  <li>
                    {language === "es"
                      ? "No envíes malware"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Respeta los horarios de los usuarios"
                      : "Respect users' hours"}
                  </li>
                  <li>
                    {language === "es"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "El usuario debe haber optado por recibir mensajes"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Puedes usar variables para personalizar"
                      : "You can use variables to personalize"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Las variables deben ser claras"
                      : "Variables must be clear"}
                  </li>
                  <li>
                    {language === "es"
                      ? "No puedes usar variables para ocultar contenido"
                      : "You cannot use variables to hide content"}
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "No puedes compartir un número entre múltiples negocios"
                      : "You cannot share a number between multiple businesses"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Cada negocio necesita su propio número"
                      : "Each business needs its own number"}
                  </li>
                  <li>
                    {language === "es"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Debes ser justo en disputas"
                      : "You must be fair in disputes"}
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es" ? "Drogas ilegales" : "Illegal drugs"}
                  </li>
                  <li>{language === "es" ? "Armas" : "Weapons"}</li>
                  <li>
                    {language === "es" ? "Falsificación" : "Counterfeiting"}
                  </li>
                </ul>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  <strong>
                    {language === "es" ? "Suspensión:" : "Suspension:"}
                  </strong>
                </p>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  <strong>
                    {language === "es" ? "Terminación:" : "Termination:"}
                  </strong>
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es" ? "Pérdida de número" : "Loss of number"}
                  </li>
                  <li>
                    {language === "es"
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4 mt-8">
                  {language === "es"
                    ...
                    : "11. Country-specific regulations"}
                </h3>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es" ? "GDPR en Europa" : "GDPR in Europe"}
                  </li>
                  <li>
                    {language === "es"
                      ? "CCPA en California"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Debes cumplir con leyes locales"
                      : "You must comply with local laws"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Algunos países restringen ciertos tipos de mensajes"
                      : "Some countries restrict certain types of messages"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Algunos requieren consentimiento explícito por escrito"
                ...
                <ol className="list-decimal pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    <strong>
                      {language === "es" ? "Sé transparente" : "Be transparent"}
                    </strong>
                    <ul className="list-disc pl-6 space-y-1 mt-2">
                      <li>
                        {language === "es"

              ...
              <article className="prose prose-lg max-w-none">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "Understanding pricing models is crucial to choosing the right platform. Let's see how different platforms charge."}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "You pay a fixed amount each month, regardless of usage."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Crear.chat: $99-$499/mes"
                      : "Crear.chat: $99-$499/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Wati: $25-$299/mes"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Pagas igual aunque uses poco"
                      : "You pay the same even if you use little"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Puede ser caro para grandes volúmenes"
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  <strong>
                    {language === "es" ? "Mejor para:" : "Best for:"}
                  </strong>{" "}
                  {language === "es"
                    ? "Empresas con uso consistente"
                    : "Companies with consistent usage"}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "You pay based on the number of messages sent or received."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Twilio: $0.0075 por mensaje"
                      : "Twilio: $0.0075 per message"}
                  </li>
                  <li>
                    {language === "es"
                      ? "MessageBird: $0.01-$0.05 por mensaje"
                      : "MessageBird: $0.01-$0.05 per message"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Algunos planes de Zendesk"
                      : "Some Zendesk plans"}
                  </li>
                </ul>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  ...
                  {language === "es"
                    ? "Empresas con uso variable"
                    : "Companies with variable usage"}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "You pay a base subscription + additional cost for messages or premium features."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Algunos planes de Crear.chat"
                      : "Some Crear.chat plans"}
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Puede ser caro si excedes límites"
                      : "Can be expensive if you exceed limits"}
                  </li>
                  <li>
                    {language === "es"
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "You pay based on the number of agents who can use the platform."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Zendesk: $49-$149 por agente/mes"
                      : "Zendesk: $49-$149 per agent/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Intercom: Incluido en suscripción"
                      : "Intercom: Included in subscription"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Algunos planes de Freshdesk"
                      : "Some Freshdesk plans"}
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Fácil de predecir costos"
                      : "Easy to predict costs"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Escalable con el equipo"
                      : "Scalable with the team"}
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Incentiva a no contratar"
                      : "Incentivizes not hiring"}
                  </li>
                </ul>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  ...
                  {language === "es"
                    ? "Empresas con equipo estable"
                    : "Companies with stable team"}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "Limited free version + paid plans for more features."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Chatwoot (versión community)"
                      : "Chatwoot (community version)"}
                  </li>
                </ul>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "Besides the main model, consider these components:"}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "WhatsApp charges platforms for each message sent:"}
                </p>

                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Mensajes entrantes: Generalmente gratuitos"
                      : "Incoming messages: Generally free"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Mensajes salientes: $0.0075 - $0.10 por mensaje (varía por país)"
                      : "Outgoing messages: $0.0075 - $0.10 per message (varies by country)"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Plantillas: Más baratas que mensajes normales"
                      : "Templates: Cheaper than normal messages"}
                  </li>
                </ul>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "Some platforms include this in their subscription, others charge separately."}
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Integración con CRM: $50-$200/mes"
                      : "CRM integration: $50-$200/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Integración con e-commerce: $50-$150/mes"
                      : "E-commerce integration: $50-$150/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Integraciones personalizadas: $500+"
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Chatbots básicos: Incluido"
                      : "Basic chatbots: Included"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Chatbots con IA: $100-$500/mes adicional"
                      : "AI chatbots: $100-$500/month additional"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Automatización avanzada: Personalizado"
                      : "Advanced automation: Custom"}
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Soporte por chat: Incluido o $50-$100/mes"
                      : "Chat support: Included or $50-$100/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Soporte por teléfono: $200-$500/mes"
                      : "Phone support: $200-$500/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Gestor dedicado: $1,000+/mes"
                      : "Dedicated manager: $1,000+/month"}
                  </li>
                </ul>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  <strong>
                    {language === "es" ? "Con Crear.chat:" : "With Crear.chat:"}
                  </strong>
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Mensajes WhatsApp: ~$0.75/mes"
                      : "WhatsApp messages: ~$0.75/month"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  <strong>
                    {language === "es" ? "Con Twilio:" : "With Twilio:"}
                  </strong>
                </p>

                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es" ? "Suscripción: $0" : "Subscription: $0"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Mensajes: 100 × $0.0075 = $0.75/mes"
                      : "Messages: 100 × $0.0075 = $0.75/month"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3 mt-6">
                  {language === "es"
                    ...
                    : "Medium business (10,000 conversations/month)"}
                </h4>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Mensajes WhatsApp: ~$75/mes"
                      : "WhatsApp messages: ~$75/month"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  <strong>
                    {language === "es" ? "Con Intercom:" : "With Intercom:"}
                  </strong>
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Agentes (3): $147 × 3 = $441/mes"
                      : "Agents (3): $147 × 3 = $441/month"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3 mt-6">
                  {language === "es"
                    ...
                    : "Large business (100,000 conversations/month)"}
                </h4>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    {language === "es"
                      ? "Mensajes: 100,000 × $0.0075 = $750/mes"
                      : "Messages: 100,000 × $0.0075 = $750/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Soporte: $500/mes"
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  <strong>
                    {language === "es" ? "Con Zendesk:" : "With Zendesk:"}
                  </strong>
                </p>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    {language === "es"
                      ? "Suscripción: $1,000/mes"
                      : "Subscription: $1,000/month"}
                  </li>
                  <li>
                    {language === "es"
                      ? "Agentes (10): $99 × 10 = $990/mes"
                      : "Agents (10): $99 × 10 = $990/month"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                ...
                <ol className="list-decimal pl-6 space-y-2 text-gray-600 mb-6">
                  <li>
                    <strong>
                      {language === "es"
                        ? "Estima tu volumen mensual:"
                        : "Estimate your monthly volume:"}
                    </strong>{" "}
                    {language === "es"
                      ? "¿Cuántos mensajes enviarás/recibirás?"
                      : "How many messages will you send/receive?"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                    ...
                    {language === "es"
                      ? "¿Suscripción fija o pago por uso?"
                      : "Fixed subscription or pay per use?"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                    ...
                    {language === "es"
                      ? "Integraciones, soporte, automatización"
                  ...
                  <li>
                    ...
                    {language === "es"
                      ? "Las plataformas pueden negociar"
                      : "Platforms can negotiate"}
                  </li>
                </ol>
                ...
                <ol className="list-decimal pl-6 space-y-2 text-gray-600 mb-6">
                  ...
                  <li>
                    ...
                    {language === "es"
                      ? "Reduce necesidad de agentes"
                      : "Reduces need for agents"}
                  </li>
                  <li>
                    <strong>
                      {language === "es" ? "Usa plantillas:" : "Use templates:"}
                    </strong>{" "}
                    {language === "es"
                      ? "Son más baratas que mensajes normales"
                      : "They are cheaper than normal messages"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                    ...
                    {language === "es"
                      ? "Plataformas ofrecen descuentos por volumen"
                      : "Platforms offer volume discounts"}
                  </li>
                  <li>
                    <strong>
                      {language === "es"
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : 'There is no universal "right price". The best price is one that:'}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "Most platforms offer free trials. Use them to better understand how they charge and what to expect in your specific case."}
                </p>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  {language === "es"
                    ...
                    : "Remember: the lowest price is not always the best option. Sometimes, paying more for better support and features can save you money in the long run."}
                </p>
              </article>
                  ...
                  <div className="text-right">
                    ...
                    >
                      {language === "es"
                        ...
                        : "What should I consider when selecting a WhatsApp provider and platform?"}
                    </a>
                  </div>
                </div>
              </div>
